...
type PaymentClient interface {
	Create(ctx context.Context, in *PaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
}
...
func (c *paymentClient) Create(ctx context.Context, in *PaymentRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
...
func (UnimplementedPaymentServer) Create(context.Context, *PaymentRequest) (*PaymentResponse, error) {
...
func _Payment_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServer).Create(ctx, req.(*PaymentRequest))
	}
